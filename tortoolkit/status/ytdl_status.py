...
class YTDLStatus(BaseStatus):
    ...
    async def update_now(self, get_msg=False):
        ...
        data = "upcancel {} {} {}".format(
            user_msg.chat_id, user_msg.id, user_msg.sender_id
        )
    ...
    async def create_message(self):
        ...
        msg = "<b>Downloading:</b> <code>{}</code>\n".format(self._dl_task["filename"])
        msg += "<b>Down:</b> {}\n".format(self._dl_task["_speed_str"])
        try:
        ...
        msg += "<b>Progress:</b> {} - {}\n".format(
            self.progress_bar(perce / 100), self._dl_task["_percent_str"]
        )
