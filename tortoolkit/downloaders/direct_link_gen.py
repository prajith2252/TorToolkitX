    ...
    async def generate_directs(self, url):
        ...
        # mediafire.com
            ...
            try:
                ...
                self._is_errored = True
                self._error_reason = (
                    "**ERROR:** Cant't download, double check your mediafire link!"
                )
                return False
        ...
        # disk.yandex.com
            ...
            try:
                ...
                self._is_errored = True
                self._error_reason = (
                    "**ERROR:** Cant't download, double check your yadisk link!"
                )
                return False
        ...
        # zippyshare.com
            ...
            try:
                ...
                self._is_errored = True
                self._error_reason = (
                    "**ERROR:** Cant't download, double check your zippyshare link!"
                )
                return False
        ...
        # racaty.net
            ...
            try:
                ...
                self._is_errored = True
                self._error_reason = (
                    "**ERROR:** Cant't download, double check your racaty link!"
                )
                return False
            ...
            if restext["success"]:
                ...
                self._is_errored = True
                self._error_reason = "**ERROR:** Cant't download, {}.".format(
                    restext["value"]
                )
                return False
        else:
